...
export default function CalculatorPage() {
  ...
  // The consolidated rate is what the worker gets paid.
  // Management fee, NI, and subsistence are all ADDED ON TOP.
  ...
  // Total charge to client = all costs + management fee
        ...
        <Tabs value={mode} onValueChange={(v) => setMode(v as 'contract' | 'perm')} className="w-full">
          ...
          <TabsContent value="contract" className="m-0">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              {/* Left column: inputs + subsistence stacked */}
              ...
              {/* Right column: breakdown + projections */}
              <div className="lg:col-span-7 bg-primary text-primary-foreground rounded-2xl shadow-xl overflow-hidden flex flex-col">
                <div className="p-8 md:p-10 flex-grow">
                  ...
                  <div className="space-y-3">
                    ...
                    {includeNI && <LineItem label="Employers NIC" value={cEmployerNI} />}
                    {includeSubsistence && cSubsistenceAmt > 0 && (
                      <LineItem label="Subsistence" value={cSubsistenceAmt} />
                    )}
                    <LineItem
                      label={`Management Fee (${cMargin > 0 ? `${cMargin}%` : '—'})`}
                ...
                <div className="bg-primary-foreground/5 p-8 md:p-10 border-t border-primary-foreground/10">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <ProjectionCard
                      label="Weekly"
                      days={5}
                      totalCharge={cTotalCharge}
                      consolidatedRate={cRate}
                      managementFee={cManagementFee}
  ...
  return (
    <div className="bg-primary-foreground/5 p-5 rounded-xl">
      <div className="text-sm font-bold text-primary-foreground/80 mb-3 flex items-center justify-between">
        {label}
        <span className="text-xs font-medium text-primary-foreground/50 tracking-normal">{days} Days</span>
      </div>
